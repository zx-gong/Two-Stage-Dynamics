...
from laser3.gptj_laser import GPTJLaser
from laser3.llama2_laser import LLAMA2Laser
from laser3.mujoco_dt_laser import MujocoDTLaser
from laser3.phi1_5_laser import Phi15Laser
from laser3.roberta_laser import RobertaLaser
from laser3.gpt2_laser import GPT2Laser
...
class LaserWrapper:
    ...
    def get_edited_model(model, lname, lnum, rate, intervention="rank-reduction", logger=None, in_place=True):
        ...
        if type(model) == LlamaForCausalLM:
            ...
            logger.log("Editing a GPT2ForCausalLM Model")
            return GPT2Laser.get_edited_model(model=model,
                                              lname=lname,
                                              lnum=lnum,
                                              rate=rate,
                                              intervention=intervention,
